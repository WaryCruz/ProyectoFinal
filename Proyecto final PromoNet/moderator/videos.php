...
<h2>Order by</h2>
	...
	<br>
	<a class="tipS" title="Show featured only" href="<?php echo add_sort('featured');?>"><i class="material-icons">&#xE83A;</i> Featured only</a>
	<a class="tipS" title="Show featured only" href="<?php echo add_sort('premium');?>"><i class="material-icons">&#xE8D0;</i> Premium only</a>
<a class="tipS" title="Show youtube only" href="<?php echo add_sort('youtube');?>"><i class="material-icons">&#xE3D6;</i> Youtube only</a>
	</div>
                              ...
                              <tr>
								...
								<div class="inline inline-elements">
								 ...
								 <button class="btn btn-primary btn-sm tipS" type="submit" title="<?php echo _lang("Do mass action"); ?>"><i class="material-icons">&#xE877;</i></button>
								  <span class="pull-right"><?php echo _lang("Videos"); ?>	</span>						  
								  </th>
						  ...
						  <?php foreach ($videos as $video) { ?>
                              <tr>
								...
								<a class="dropdown-toggle" title="Options"  data-toggle="dropdown" href="#" aria-expanded="false" data-animation="scale-up" role="button"><i class="material-icons">&#xE164;</i></a>
								  ...
								  ?>
								  <span class="badge"><i class="material-icons">&#xE0B9;</i> <a href="<?php echo admin_url('ytcoms').'&local='.$video->id.'&yt='.$match[1];?>"> Import comments</a></span>
								  <?php } ?>
