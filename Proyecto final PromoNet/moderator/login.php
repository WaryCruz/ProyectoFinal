...
<div class="row">
<div class="col-md-4">
<input type="text" name="COOKIEKEY" class="col-md-12" value="<?php echo get_option('COOKIEKEY'); ?>"><span class="help-block">Custom  <strong>cookie key</strong> </span>
</div>
<div class="col-md-4">
<input type="text" name="SECRETSALT" class="col-md-12" value="<?php echo get_option('SECRETSALT'); ?>"><span class="help-block align-center"> Secret encryption <strong>salt</strong> (Only keys of sizes 16, 24 or 32 supported)</span>
</div>
<div class="col-md-4">
<input type="text" name="COOKIESPLIT" class="col-md-12" value="<?php echo get_option('COOKIESPLIT'); ?>"><span class="help-block align-center">Cookie <strong>split</strong></span>
</div>
</div>
</div>
</div>
